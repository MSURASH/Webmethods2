 ...
 * 
 */
public class closeLogStream_TestHarness
{
    ...
    public static void main(String[] args)
    {
        ...
        String svcName = "Logging.closeStream:closeLogStream";  //$NON-NLS-1$
    	...
    	if (nsService != null) {
            ...
            if (sig != null) {
                ...
                if (inputRecord != null && inputRecord.getFieldCount() > 0) {
                    ...
                    Class currentClass = Logging.closeStream.closeLogStream_TestHarness.class;
        ...
        throws IOException, ServiceException, com.wm.app.b2b.server.ServiceException, NetException
    {
        ...
        //closeLogStream_SVC.closeLogStream(inDoc);
