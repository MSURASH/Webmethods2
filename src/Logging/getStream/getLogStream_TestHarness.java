 ...
 * 
 */
public class getLogStream_TestHarness
{
    ...
    public static void main(String[] args)
    {
        ...
        String svcName = "Logging.getStream:getLogStream";  //$NON-NLS-1$
    	...
    	if (nsService != null) {
            ...
            if (sig != null) {
                ...
                if (inputRecord != null && inputRecord.getFieldCount() > 0) {
                    ...
                    Class currentClass = Logging.getStream.getLogStream_TestHarness.class;
        ...
        throws IOException, ServiceException, com.wm.app.b2b.server.ServiceException, NetException
    {
        ...
        //getLogStream_SVC.getLogStream(inDoc);
