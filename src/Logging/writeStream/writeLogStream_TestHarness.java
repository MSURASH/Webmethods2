 ...
 * 
 */
public class writeLogStream_TestHarness
{
    ...
    public static void main(String[] args)
    {
        ...
        String  server = "host.docker.internal:5555";  //$NON-NLS-1$
        ...
        String svcName = "Logging.writeStream:writeLogStream";  //$NON-NLS-1$
    	...
    	if (nsService != null) {
            ...
            if (sig != null) {
                ...
                if (inputRecord != null && inputRecord.getFieldCount() > 0) {
                    ...
                    Class currentClass = Logging.writeStream.writeLogStream_TestHarness.class;
    ...
    {
        IData inDoc = inputDocument;
        //writeLogStream_SVC.writeLogStream(inDoc);
